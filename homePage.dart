          ...
          SliverAppBar(
            ...
            flexibleSpace: Container(
              ...
              child:Stack(
                children: [
                  Container(
                  child:  Image.asset('avatar.jpg',fit: BoxFit.fill,),
                    width: 1600,
                    height: 500,
                    color: Colors.white,
                  ),
                ...
                child: Column(
                  children: [
                          ...
                          Column(
                            children: [
                              Padding(
                                ...
                                child: Text('Shaniba',style: TextStyle(
                                    fontSize: 25,
                                color: Colors.black26),),
                              ),
                              Padding(
                                  padding: EdgeInsets.only(left: 20),
                                child: Text('Shaniba_9',style: TextStyle(
                                    fontSize: 15,
                                    color: Colors.grey),),
                              )
                            ],
                    ...
                    Container(
                      ...
                      BoxDecoration(
                          image: DecorationImage(fit:BoxFit.fill,
                              image: AssetImage('assets/snapchat cameo.png')),
                          borderRadius: BorderRadius.circular(20),
                          boxShadow: [
                            BoxShadow(color: Colors.grey.withOpacity(0.5),
                              spreadRadius: 5,
